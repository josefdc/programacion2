...
void nPrimerosNumeros(int n, int current);
...
bool esPar(int x);
void submultiplos(int x, int current);
bool esPrimo(int n);
bool esPrimoAux(int n, int i);
int fibonacci(int n);
void primerosFibonacci(int n, int current);
...
void mostrarMenu() {
    ...
    printf("7. Sumatoria de x^x para todos los numeros entre 1 y N\n");
    printf("8. Elevar un numero x a la y\n");
    printf("9. Indicar si un numero x es par o impar\n");
    printf("10. Mostrar los submultiplos de x\n");
    printf("11. Indicar si un numero es primo o no\n");
    printf("12. n-esimo numero de la serie de Fibonacci\n");
    printf("13. Mostrar los n primeros numeros de la serie de Fibonacci\n");
    printf("14. Minimo comun multiplo de dos numeros\n");
    printf("15. Maximo comun divisor de dos numeros\n");
    printf("16. Pasos para resolver las torres de Hanoi con n anillos\n");
    printf("17. Salir\n");
    printf("Seleccione una opcion (1-17)?\n");
    scanf("%d", &opcion);
    ...
    if (opcion == 1) {
        ...
        printf("Introduce el numero el numero mayor para imprimir los primeros numeros: ");
        scanf("%d", &n);
        nPrimerosNumeros(n, 1);
    } else if (opcion == 3) {
        printf("Introduce el numero para mostrar la tabla de multiplicar: ");
        scanf("%d", &n);
        tablaMultiplicar(n, 1);
    } else if (opcion == 4) {
        printf("Introduce el numero N para mostrar todas las tablas hasta N: ");
        scanf("%d", &n);
        imprimirTablas(1, n);
    } else if (opcion == 5) {
        printf("Introduce el numero N para mostrar la sumatoria de los numeros enteros hasta N: ");
        scanf("%d", &n);
        printf("Sumatoria: %d\n", sumatoria(n));
    } else if (opcion == 6) {
        printf("Introduce el numero N para mostrar el factorial de N: ");
        scanf("%d", &n);
        printf("Factorial: %d\n", factorial(n));
    } else if (opcion == 7) {
        printf("Introduce el numero N para mostrar la sumatoria de x^x para todos los numeros entre 1 y N: ");
        scanf("%d", &n);
        printf("Sumatoria: %d\n", sumatoriaExpresion(n));
    } else if (opcion == 8) {
        printf("Introduce la base x: ");
        scanf("%d", &x);
        printf("Introduce el exponente y: ");
        scanf("%d", &y);
        printf("Resultado: %d\n", elevarNumero(x, y));
    } else if (opcion == 9) {
        ...
        printf("Introduce el numero x para mostrar sus submultiplos: ");
        scanf("%d", &x);
        submultiplos(x, x-1);
    } else if (opcion == 11) {
        printf("Introduce un numero para verificar si es primo: ");
        scanf("%d", &n);
        if (esPrimo(n)) {
        ...
        printf("Introduce el valor n para obtener el n-esimo numero de la serie de Fibonacci: ");
        scanf("%d", &n);
        printf("Resultado: %d\n", fibonacci(n));
    } else if (opcion == 13) {
        printf("Introduce el valor n para mostrar los n primeros numeros de la serie de Fibonacci: ");
        scanf("%d", &n);
        for(int i = 1; i <= n; i++) {
        ...
        printf("Introduce dos numeros para encontrar su minimo comun multiplo: ");
        scanf("%d%d", &a, &b);
        printf("Minimo comun multiplo: %d\n", minimoComunMultiplo(a, b));
    } else if (opcion == 15) {
        printf("Introduce dos numeros para encontrar su maximo comun divisor: ");
        scanf("%d%d", &a, &b);
        printf("Maximo comun divisor: %d\n", maximoComunDivisor(a, b));
    } else if (opcion == 16) {
        printf("Introduce el numero de anillos para las torres de Hanoi: ");
        scanf("%d", &n);
        torresDeHanoi(n);
    } else if (opcion == 17) {
    ...
    // Return to the main menu after executing an option if the user didn't choose to exit
    if (opcion != 17) {
        mostrarMenu();
    }
}
